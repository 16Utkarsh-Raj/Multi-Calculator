...
public class Angle_Converter {
	...
	private Double cnvrt(double val, String select1, String select2) {
		double result=0.00;
		
		if(select1.equals("Degree")) {
			if(select2.equals("Radian"))
				result=val*(3.14/180);
			else if(select2.equals("Gradian"))
				result=val*1.1111;
			else
				result=val;
		}
		else if(select1.equals("Radian")) {
			if(select2.equals("Degree"))
				result=val*(180/3.14);
			else if(select2.equals("Gradian"))
				result=val*63.6619;
			else
		...
		else if(select1.equals("Gradian")) {
			if(select2.equals("Degree"))
				result=val*(180/200);
			else if(select2.equals("Radian"))
				result=val*(3.14/200);
			else
				result=val;
		}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Angle_Converter window = new Angle_Converter(false, page_arr, -1);
	...
	public Angle_Converter(Boolean prev_nxt_clicked, String[] elements, int indx) {
		initialize();
		prev_next obj=new prev_next(elements);
		page_arr=obj.add(prev_nxt_clicked, "angle", indx);
		if(prev_nxt_clicked)
			index=indx;
		else
	...
	private void initialize() {
		...
		frame.setTitle("Angle Converter");
		...
		unit1 = new JComboBox();
		unit1.setModel(new DefaultComboBoxModel(new String[] {"Choose One", "Degree", "Radian", "Gradian"}));
		...
		unit2 = new JComboBox();
		unit2.setModel(new DefaultComboBoxModel(new String[] {"Choose One", "Degree", "Radian", "Gradian"}));
		...
		AngleMenu.setBackground(new Color(0, 0, 90));
