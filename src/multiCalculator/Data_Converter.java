...
public class Data_Converter {
	double Bit=8000000; // 1MB=8000000 Bits
    double Byte=1000000; // 1MB=1000000Bytes
    double Kb=8000; // 1MB=8000000 Kilobits
    double KB=1000; //1MB=1000 Kilobytes
    double Mb=8; // 1MB=8 Magabits
    double MB=1; // 1MB=1000 Megabytes
    double Gb=0.008; // 1MB=0.008 Gigabits
    double GB=0.001; // 1MB=0.001 Gigabytes
    double Tb=0.000008; // 1MB=0.000008 Terabits
    double TB=0.0000000001; // 1mB=0.000000001 Terabytes
    double Pb=0.000000008; // 1MB=0.000000008 Petabits
    double PB=0.000000001; // 1MB=0.000000001 Petabytes
    double Eb=0.000000000008; // 1MB=0.000000000008 Exabits
    double EB=0.000000000001; // 1MB=0.000000000001 Exabytes
    double Zb=0.000000000000008; // 1MB=0.000000000000008 Zetabits
    double ZB=0.000000000000001; // 1MB=0.000000000000001 Zetabytes
	...
	// Result function
	private void result() {
		if(!t1.getText().equals("") && !unit1.getSelectedItem().equals("Choose One") && !unit2.getSelectedItem().equals("Choose One")) {
			double unitToChange = Double.parseDouble(t1.getText());
			
//			if(unit1.getSelectedItem().toString())
	        String value = String.valueOf(cnvrt(unitToChange, unit1.getSelectedItem().toString(), unit2.getSelectedItem().toString()));
	        t2.setText(value);
		}
		else
			t2.setText(null);
	...
	private Double cnvrt(double unit, String select1, String select2) {
		double unitToChange=unit;
		double unitInMB=0.0;
		
		switch(select1)
        {
            case "Bits": unitInMB = unitToChange/Bit;
            break;
            case "Bytes": unitInMB= unitToChange/Byte;
            break;
            case "Kilobits": unitInMB = unitToChange/Kb;
            break;
            case "Kilobytes": unitInMB = unitToChange/KB;
            break;
            case "Megabits": unitInMB = unitToChange/Mb;
            break;
            case "Megabytes": unitInMB = unitToChange/MB;
            break;
            case "Gigabits": unitInMB = unitToChange/Gb;
            break;
            case "Gigabytes": unitInMB = unitToChange/GB;
            break;
            case "Terabits": unitInMB= unitToChange/Tb;
            break;
            case "Terabytes": unitInMB = unitToChange/TB;
            break;
            case "Petabits": unitInMB = unitToChange/Pb;
            break;
            case "Petabytes": unitInMB = unitToChange/PB;
            break;
            case "Exabits": unitInMB = unitToChange/Eb;
            break;
            case "Exabytes": unitInMB = unitToChange/EB;
            break;
            case "Zetabits": unitInMB = unitToChange/Zb;
            break;
            case "Zetabytes": unitInMB = unitToChange/ZB;
            break;
        }
        
        double unitChanged=0.0;
        switch(select2)
        {
	        case "Bits": unitChanged = unitInMB*Bit;
	        break;
	        case "Bytes": unitChanged = unitInMB*Byte;
	        break;
	        case "Kilobits": unitChanged = unitInMB*Kb;
	        break;
	        case "Kilobytes": unitChanged = unitInMB*KB;
	        break;
	        case "Megabits": unitChanged = unitInMB*Mb;
	        break;
	        case "Megabytes": unitChanged = unitInMB*MB;
	        break;
	        case "Gigabits": unitChanged = unitInMB*Gb;
	        break;
	        case "Gigabytes": unitChanged = unitInMB*GB;
	        break;
	        case "Terabits": unitChanged= unitInMB*Tb;
	        break;
	        case "Terabytes": unitChanged = unitInMB*TB;
	        break;
	        case "Petabits": unitChanged = unitInMB*Pb;
	        break;
	        case "Petabytes": unitChanged = unitInMB*PB;
	        break;
	        case "Exabits": unitChanged = unitInMB*Eb;
	        break;
	        case "Exabytes": unitChanged = unitInMB*EB;
	        break;
	        case "Zetabits": unitChanged = unitInMB*Zb;
	        break;
	        case "Zetabytes": unitChanged = unitInMB*ZB;
	        break;
        }
        return unitChanged;
	}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Data_Converter window = new Data_Converter(false, page_arr, -1);
	...
	public Data_Converter(Boolean prev_nxt_clicked, String[] elements, int indx) {
		initialize();
		prev_next obj=new prev_next(elements);
		page_arr=obj.add(prev_nxt_clicked, "Data", indx);
		if(prev_nxt_clicked)
			index=indx;
		else
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 445, 486);
		frame.setTitle("Data Converter");
		...
		lblFromUnit.setForeground(Color.WHITE);
		lblFromUnit.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 18));
		...
		unit1.setModel(new DefaultComboBoxModel(new String[] {"Choose One", "Bits", "Bytes", "Kilobits", "Kilobytes", "Megabits", "Megabytes", "Gigabits", "Gigabytes", "Terabits", "Terabytes", "Petabits", "Petabytes", "Exabits", "Exabytes", "Zetabits", "Zetabytes"}));
		unit1.setForeground(new Color(0, 204, 255));
		unit1.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 16));
		...
		t1.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 16));
		t1.setColumns(10);
		t1.setBorder(null);
		t1.setBackground(new Color(0, 0, 102));
		...
		unit1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				switch(unit1.getSelectedItem().toString())
		        {
		            ...
		            case "Bytes": SI1 = "Byte";
		            break;
		            case "Kilobits": SI1 = "Kb";
		            break;
		            case "Kilobytes": SI1 = "KB";
		            break;
		            case "Megabits": SI1 = "Mb";
		            break;
		            case "Megabytes": SI1 = "MB";
		            break;
		            case "Gigabits": SI1 = "Gb";
		            break;
		            case "Gigabytes": SI1 = "GB";
		            break;
		            case "Terabits": SI1 = "Tb";
		            break;
		            case "Terabytes": SI1 = "TB";
		            break;
		            case "Petabits": SI1 = "Pb";
		            break;
		            case "Petabytes": SI1 = "PB";
		            break;
		            case "Exabits": SI1 = "Eb";
		            break;
		            case "Exabbytes": SI1 = "EB";
		            break;
		            case "Zetabits": SI1 = "Zb";
		            break;
		            case "Zetabytes": SI1 = "ZB";
		            break;
		...
		lblToUnit.setForeground(Color.WHITE);
		lblToUnit.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 18));
		...
		unit2.setModel(new DefaultComboBoxModel(new String[] {"Choose One", "Bits", "Bytes", "Kilobits", "Kilobytes", "Megabits", "Megabytes", "Gigabits", "Gigabytes", "Terabits", "Terabytes", "Petabits", "Petabytes", "Exabits", "Exabytes", "Zetabits", "Zetabytes"}));
		unit2.setForeground(new Color(0, 204, 255));
		unit2.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 16));
		...
		t2.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 16));
		t2.setColumns(10);
		t2.setBorder(null);
		t2.setBackground(new Color(0, 0, 102));
		...
		unit2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				switch(unit2.getSelectedItem().toString())
		        {
		            ...
		            case "Bytes": SI2 = "Byte";
		            break;
		            case "Kilobits": SI2 = "Kb";
		            break;
		            case "Kilobytes": SI2 = "KB";
		            break;
		            case "Megabits": SI2 = "Mb";
		            break;
		            case "Megabytes": SI2 = "MB";
		            break;
		            case "Gigabits": SI2 = "Gb";
		            break;
		            case "Gigabytes": SI2 = "GB";
		            break;
		            case "Terabits": SI2 = "Tb";
		            break;
		            case "Terabytes": SI2 = "TB";
		            break;
		            case "Petabits": SI2 = "Pb";
		            break;
		            case "Petabytes": SI2 = "PB";
		            break;
		            case "Exabits": SI2 = "Eb";
		            break;
		            case "Exabbytes": SI2 = "EB";
		            break;
		            case "Zetabits": SI2 = "Zb";
		            break;
		            case "Zetabytes": SI2 = "ZB";
		            break;
		        }
				U2.setText(SI2);
				result();
						...
						.addGroup(gl_panel_2.createSequentialGroup()
							...
							.addGroup(gl_panel_2.createParallelGroup(Alignment.TRAILING, false)
								.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING, false)
									.addComponent(lblFromUnit, GroupLayout.PREFERRED_SIZE, 273, GroupLayout.PREFERRED_SIZE)
									.addGroup(gl_panel_2.createParallelGroup(Alignment.TRAILING, false)
										.addGroup(gl_panel_2.createSequentialGroup()
											.addComponent(t1)
											.addGap(18)
											.addComponent(U1, GroupLayout.PREFERRED_SIZE, 51, GroupLayout.PREFERRED_SIZE))
										.addComponent(unit1, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 310, GroupLayout.PREFERRED_SIZE)
										.addGroup(gl_panel_2.createSequentialGroup()
											.addComponent(t2, GroupLayout.PREFERRED_SIZE, 244, GroupLayout.PREFERRED_SIZE)
											.addGap(20)
											.addComponent(U2, GroupLayout.PREFERRED_SIZE, 46, GroupLayout.PREFERRED_SIZE))))
								.addGroup(gl_panel_2.createSequentialGroup()
									.addComponent(lblToUnit, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
									.addGap(10))
								.addComponent(unit2, Alignment.LEADING, GroupLayout.PREFERRED_SIZE, 311, GroupLayout.PREFERRED_SIZE)))
						.addGroup(gl_panel_2.createSequentialGroup()
							.addGap(14)
		...
		gl_panel_2.setVerticalGroup(
			gl_panel_2.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_panel_2.createSequentialGroup()
					.addContainerGap()
					.addComponent(lblFromUnit, GroupLayout.PREFERRED_SIZE, 24, GroupLayout.PREFERRED_SIZE)
					.addGap(10)
					.addComponent(unit1, GroupLayout.PREFERRED_SIZE, 24, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE)
						.addComponent(t1, GroupLayout.PREFERRED_SIZE, 24, GroupLayout.PREFERRED_SIZE)
						.addComponent(U1, GroupLayout.PREFERRED_SIZE, 18, GroupLayout.PREFERRED_SIZE))
					.addGap(18)
					.addComponent(lblToUnit, GroupLayout.PREFERRED_SIZE, 24, GroupLayout.PREFERRED_SIZE)
					.addPreferredGap(ComponentPlacement.UNRELATED)
					.addComponent(unit2, GroupLayout.PREFERRED_SIZE, 24, GroupLayout.PREFERRED_SIZE)
					.addGap(10)
					.addGroup(gl_panel_2.createParallelGroup(Alignment.BASELINE)
						.addComponent(t2, GroupLayout.PREFERRED_SIZE, 24, GroupLayout.PREFERRED_SIZE)
		...
		DataMenu.setBackground(new Color(0, 0, 90));
