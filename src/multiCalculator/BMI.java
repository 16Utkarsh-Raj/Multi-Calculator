...
public class BMI {
	...
	private void initialize() {
		...
		btn_equal.setForeground(new Color(0, 204, 255));
		btn_equal.setFont(new Font("Rockwell Extra Bold", Font.PLAIN, 20));
		btn_equal.setFocusable(false);
		btn_equal.setBorder(null);
		btn_equal.setBackground(new Color(0, 0, 102));
						...
						.addGroup(gl_btnPanel.createSequentialGroup()
							...
							.addGroup(gl_btnPanel.createParallelGroup(Alignment.LEADING)
								...
								.addGroup(gl_btnPanel.createSequentialGroup()
									...
									.addGap(62)
									.addComponent(btn_equal, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE))))
						.addGroup(gl_btnPanel.createSequentialGroup()
							.addGap(102)
			...
			gl_btnPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_btnPanel.createSequentialGroup()
					...
					.addGroup(gl_btnPanel.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(btn_equal, GroupLayout.PREFERRED_SIZE, 25, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(ComponentPlacement.RELATED)
					.addGroup(gl_btnPanel.createParallelGroup(Alignment.LEADING)
