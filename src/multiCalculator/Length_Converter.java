...
public class Length_Converter {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Length_Converter window = new Length_Converter(false, page_arr, -1);
	...
	public Length_Converter(Boolean prev_nxt_clicked, String[] elements, int indx) {
		initialize();
		prev_next obj=new prev_next(elements);
		page_arr=obj.add(prev_nxt_clicked, "length", indx);
		if(prev_nxt_clicked)
			index=indx;
		else
	...
	private void result() {
		if(!t1.getText().equals("") && !unit1.getSelectedItem().equals("--From Unit--") && !unit2.getSelectedItem().equals("--To Unit--")){
            ...
            else if(box1.equals("Metre") && box2.equals("Centimetre"))
            {
                double m = Double.parseDouble(t1.getText());
            ...
            else if(box1.equals("Metre") && box2.equals("Millimetre"))
            {
                double m = Double.parseDouble(t1.getText());

                double mm = (double)(m*1000);

                t2.setText(String.valueOf(mm));
            }
            else if(box1.equals("Metre") && box2.equals("Hectometre"))
            {
                double m = Double.parseDouble(t1.getText());

                double hm = (double)(m/100);

                t2.setText(String.valueOf(hm));
            }
            else if(box1.equals("Metre") && box2.equals("Decimetre"))
            {
                double m = Double.parseDouble(t1.getText());

                double dm = (double)(m*10);

                t2.setText(String.valueOf(dm));
            }
            else if(box1.equals("Metre") && box2.equals("Metre"))
            {
                double m = Double.parseDouble(t1.getText());
            ...
            else if(box1.equals("Centimetre") && box2.equals("Centimetre"))
            {
                double cm = Double.parseDouble(t1.getText());

                t2.setText(String.valueOf(cm));
            }
            else if(box1.equals("Centimetre") && box2.equals("Millimetre"))
            {
                double cm = Double.parseDouble(t1.getText());
            ...
            else if(box1.equals("Centimetre") && box2.equals("Hectometre"))
            {
                double cm = Double.parseDouble(t1.getText());

                double hm = (double)(cm/10000);

                t2.setText(String.valueOf(hm));
            }
            else if(box1.equals("Centimetre") && box2.equals("Decimetre"))
            {
                double cm = Double.parseDouble(t1.getText());

                double dm = (double)(cm/10);

                t2.setText(String.valueOf(dm));
            }
            else if(box1.equals("Centimetre") && box2.equals("Metre"))
            {
                double cm = Double.parseDouble(t1.getText());
            ...
            {
                double dm = Double.parseDouble(t1.getText());

                double km = (double)(dm/10000);

                t2.setText(String.valueOf(km));
            }
            else if(box1.equals("Decimetre") && box2.equals("Centimetre"))
            {
                double dm = Double.parseDouble(t1.getText());
                
                double cm = (double)(dm*10);

                t2.setText(String.valueOf(cm));
            }
            else if(box1.equals("Decimetre") && box2.equals("Millimetre"))
            {
                double dm = Double.parseDouble(t1.getText());

                double mm = (double)(dm*100);

                t2.setText(String.valueOf(mm));
            }
            else if(box1.equals("Decimetre") && box2.equals("Hectometre"))
            {
                double dm = Double.parseDouble(t1.getText());

                double hm = (double)(dm/1000);

                t2.setText(String.valueOf(hm));
            }
            else if(box1.equals("Decimetre") && box2.equals("Decimetre"))
            {
                double dm = Double.parseDouble(t1.getText());

                t2.setText(String.valueOf(dm));
            }
            else if(box1.equals("Decimetre") && box2.equals("Metre"))
            {
                double dm = Double.parseDouble(t1.getText());

                double m = (double)(dm/10);
            ...
            if(box1.equals("Millimetre") && box2.equals("Kilometre"))
            {
                ...
                double km = (double)(mm/(1e+6));

                t2.setText(String.valueOf(km));
            }
            else if(box1.equals("Millimetre") && box2.equals("Centimetre"))
            {
                double mm = Double.parseDouble(t1.getText());
            ...
            else if(box1.equals("Millimetre") && box2.equals("Millimetre"))
            {
                double mm = Double.parseDouble(t1.getText());

                t2.setText(String.valueOf(mm));
            }
            else if(box1.equals("Millimetre") && box2.equals("Hectometre"))
            {
                double mm = Double.parseDouble(t1.getText());

                double hm = (double)(mm/100000);

                t2.setText(String.valueOf(hm));
            }
            else if(box1.equals("Millimetre") && box2.equals("Decimetre"))
            {
                double mm = Double.parseDouble(t1.getText());
                
                double dm = (double)(mm/100);

                t2.setText(String.valueOf(dm));
            }
            else if(box1.equals("Millimetre") && box2.equals("Metre"))
            {
                double mm = Double.parseDouble(t1.getText());
            ...
            if(box1.equals("Hectometre") && box2.equals("Kilometre"))
            {
                double hm = Double.parseDouble(t1.getText());

                double km = (double)(hm/10);

                t2.setText(String.valueOf(km));
            }
            else if(box1.equals("Hectometre") && box2.equals("Centimetre"))
            {
                double hm = Double.parseDouble(t1.getText());
                
                double cm = (double)(hm*10000);

                t2.setText(String.valueOf(cm));
            }
            else if(box1.equals("Hectometre") && box2.equals("Millimetre"))
            {
                double hm = Double.parseDouble(t1.getText());
                
                double mm = (double)(hm*100000);

                t2.setText(String.valueOf(mm));
            }
            else if(box1.equals("Hectometre") && box2.equals("Hectometre"))
            {
                double hm = Double.parseDouble(t1.getText());

                t2.setText(String.valueOf(hm));
            }
            else if(box1.equals("Hectometre") && box2.equals("Decimetre"))
            {
                double hm = Double.parseDouble(t1.getText());
                
                double dm = (double)(hm*1000);

                t2.setText(String.valueOf(dm));
            }
            else if(box1.equals("Hectometre") && box2.equals("Metre"))
            {
                double hm = Double.parseDouble(t1.getText());

                double m = (double)(hm*100);
            ...
            else if(box1.equals("Kilometre") && box2.equals("Centimetre"))
            {
                double km = Double.parseDouble(t1.getText());
            ...
            else if(box1.equals("Kilometre") && box2.equals("Millimetre"))
            {
                double km = Double.parseDouble(t1.getText());
                
                double mm = (double)(km*(1e+6));

                t2.setText(String.valueOf(mm));
            }
            else if(box1.equals("Kilometre") && box2.equals("Hectometre"))
            {
                double km = Double.parseDouble(t1.getText());
                
                double hm = (double)(km*10);

                t2.setText(String.valueOf(hm));
            }
            else if(box1.equals("Kilometre") && box2.equals("Decimetre"))
            {
                double km = Double.parseDouble(t1.getText());
                
                double dm = (double)(km*10000);

                t2.setText(String.valueOf(dm));
            }
            else if(box1.equals("Kilometre") && box2.equals("Metre"))
            {
                double Km = Double.parseDouble(t1.getText());
	...
	private void initialize() {
		...
		unit1.setModel(new DefaultComboBoxModel(new String[] {"--From Unit--", "Metre", "Centimetre", "Decimetre", "Millimetre", "Hectometre", "Kilometre"}));
		...
		unit2.setModel(new DefaultComboBoxModel(new String[] {"--To Unit--", "Metre", "Centimetre", "Decimetre", "Millimetre", "Hectometre", "Kilometre"}));
		...
		public void actionPerformed(ActionEvent e) {
			...
			switch(unit1.getSelectedItem().toString())
	        {
	            case "Metre": SI1 = "m";
	            break;
	            case "Centimetre": SI1 = "cm";
	            break;
	            case "Decimetre": SI1 = "dm";
	            break;
	            case "Millimetre": SI1 = "mm";
	            break;
	            case "Hectometre": SI1 = "hm";
	            break;
	            case "Kilometre": SI1 = "km";
	            break;
	        }
			U1.setText(SI1);
			result();
		...
		unit2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				switch(unit2.getSelectedItem().toString())
		        {
		            case "Metre": SI2 = "m";
		            break;
		            case "Centimetre": SI2 = "cm";
		            break;
		            case "Decimetre": SI2 = "dm";
		            break;
		            case "Millimetre": SI2 = "mm";
		            break;
		            case "Hectometre": SI2 = "hm";
		            break;
		            case "Kilometre": SI2 = "km";
		            break;
		        }
				U2.setText(SI2);
				result();
					...
					.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel_2.createSequentialGroup()
							...
							.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING, false)
								.addComponent(unit2, 0, 0, Short.MAX_VALUE)
								.addGroup(gl_panel_2.createSequentialGroup()
									.addComponent(t1, GroupLayout.PREFERRED_SIZE, 169, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(U1, GroupLayout.PREFERRED_SIZE, 46, GroupLayout.PREFERRED_SIZE))
								.addGroup(gl_panel_2.createSequentialGroup()
									.addComponent(t2, GroupLayout.PREFERRED_SIZE, 168, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.UNRELATED)
