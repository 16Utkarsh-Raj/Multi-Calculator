...
public class Weight_Converter {
	...
	double ct=5000; // 1kg=5000 Carats
    double mg=1000000; // 1kg=1000000 Miligrams
    double cg=100000; // 1kg=100000 Centigrams
    double dg=10000; //1kg=10000 Decigrams
    double g=1000; // 1kg=1000 Grams
    double dag=100; // 1kg=100 Dacagrams
    double hg=10; // 1kg=10 Hectograms
    double kg=1; // 1kg=1 Kilograms
    double tonne=0.001; // 1kg=0.001tonne
    double oz=35.274; // 1kg=35.274 Ounces
    double lb=2.20462; // 1kg=2.20462 Pounds
    double st=0.157473; // 1kg=0.157473 Stones
    double USton=0.00110231; // 1kg=0.00110231 US Ton
    double UKton=0.000984207; // 1k0.000984207 UK Ton
	...
	private void result() {
		if(!t1.getText().equals("") && !unit1.getSelectedItem().equals("Choose one...") && !unit2.getSelectedItem().equals("Choose one...")) {
	        ...
	        String value = String.format("%.5f",cnvrt(unitToChange, unit1.getSelectedItem().toString(), unit2.getSelectedItem().toString()));
	        t2.setText(value);
		}
		else
			t2.setText(null);
	...
	private Double cnvrt(double unit, String select1, String select2) {
		...
		switch(select1)
        {
            case "Carats": unitInKG = unitToChange/ct;
            break;
            case "Miligrams": unitInKG = unitToChange/mg;
            break;
            case "Centigrams": unitInKG = unitToChange/cg;
            break;
            case "Decigrams": unitInKG = unitToChange/dg;
            break;
            case "Grams": unitInKG = unitToChange/g;
            break;
            case "Decagrams": unitInKG = unitToChange/dag;
            break;
            case "Hectograms": unitInKG = unitToChange/hg;
            break;
            case "Kilograms": unitInKG = unitToChange/kg;
            break;
            case "Metric tonnes": unitInKG= unitToChange/tonne;
            break;
            case "Ounces": unitInKG = unitToChange/oz;
            break;
            case "Pounds": unitInKG = unitToChange/lb;
            break;
            case "Stone": unitInKG = unitToChange/st;
            break;
            case "Short tons(US)": unitInKG = unitToChange/USton;
            break;
            case "Long tons(UK)": unitInKG = unitToChange/UKton;
            break;
        }
        ...
        switch(select2)
        {
            case "Carats": unitChanged = unitInKG*ct;
            break;
            case "Miligrams": unitChanged = unitInKG*mg;
            break;
            case "Centigrams": unitChanged = unitInKG*cg;
            break;
            case "Decigrams": unitChanged = unitInKG*dg;
            break;
            case "Grams": unitChanged = unitInKG*g;
            break;
            case "Decagrams": unitChanged = unitInKG*dag;
            break;
            case "Hectograms": unitChanged = unitInKG*hg;
            break;
            case "Kilograms": unitChanged = unitInKG*kg;
            break;
            case "Metric tonnes": unitChanged = unitInKG*tonne;
            break;
            case "Ounces": unitChanged = unitInKG*oz;
            break;
            case "Pounds": unitChanged = unitInKG*lb;
            break;
            case "Stone": unitChanged = unitInKG*st;
            break;
            case "Short tons(US)": unitChanged = unitInKG*USton;
            break;
            case "Long ton(UK)": unitChanged = unitInKG*UKton;
           break;
        }
        return unitChanged;
	}
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Weight_Converter window = new Weight_Converter(false, page_arr, -1);
	...
	public Weight_Converter(Boolean prev_nxt_clicked, String[] elements, int indx) {
		initialize();
		prev_next obj=new prev_next(elements);
		page_arr=obj.add(prev_nxt_clicked, "Weight", indx);
		if(prev_nxt_clicked)
			index=indx;
		else
	...
	private void initialize() {
		...
		frame.setTitle("Weight and Mass Converter");
		...
		unit1 = new JComboBox();
		unit1.setModel(new DefaultComboBoxModel(new String[] {"Choose one...", "Carats", "Miligrams", "Centigrams", "Decigrams", "Grams", "Decagrams", "Hectograms", "Kilograms", "Metric tonnes", "Ounces", "Pounds", "Stone", "Short tons(US)", "Long tons(UK)"}));
		...
		unit1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				switch(unit1.getSelectedItem().toString())
		        {
		            case "Carats": SI1 = "ct";
		            break;
		            case "Miligrams": SI1 = "mg";
		            break;
		            case "Centigrams": SI1 = "cg";
		            break;
		            case "Decigrams": SI1 = "dg";
		            break;
		            case "Grams": SI1 = "g";
		            break;
		            case "Decagrams": SI1 = "dag";
		            break;
		            case "Hectograms": SI1 = "hg";
		            break;
		            case "Kilograms": SI1 = "kg";
		            break;
		            case "Metric tonnes": SI1= "tonne";
		            break;
		            case "Ounces": SI1 = "oz";
		            break;
		            case "Pounds": SI1 = "lb";
		            ...
		            case "Stone": SI1 = "st";
		            break;
		            case "Short tons(US)": SI1 = "USton";
		            break;
		            case "Long tons(UK)": SI1 = "UKton";
		            break;
		        }
				U1.setText(SI1);
				result();
		...
		unit2 = new JComboBox();
		unit2.setModel(new DefaultComboBoxModel(new String[] {"Choose one...", "Carats", "Miligrams", "Centigrams", "Decigrams", "Grams", "Decagrams", "Hectograms", "Kilograms", "Metric tonnes", "Ounces", "Pounds", "Stone", "Short tons(US)", "Long tons(UK)"}));
		...
		unit2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				switch(unit2.getSelectedItem().toString())
		        {
		            case "Carats": SI2 = "ct";
		            break;
		            case "Miligrams": SI2 = "mg";
		            break;
		            case "Centigrams": SI2 = "cg";
		            break;
		            case "Decigrams": SI2 = "dg";
		            break;
		            case "Grams": SI2 = "g";
		            break;
		            case "Decagrams": SI2 = "dag";
		            break;
		            case "Hectograms": SI2 = "hg";
		            break;
		            case "Kilograms": SI2 = "kg";
		            break;
		            case "Metric tonnes": SI2= "tonne";
		            break;
		            case "Ounces": SI2 = "oz";
		            break;
		            case "Pounds": SI2 = "lb";
		            ...
		            case "Stone": SI2 = "st";
		            break;
		            case "Short tons(US)": SI2 = "USton";
		            break;
		            case "Long tons(UK)": SI2 = "UKton";
		            break;
		        }
				U2.setText(SI2);
				result();
					...
					.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING)
						...
						.addGroup(gl_panel_2.createSequentialGroup()
							...
							.addGroup(gl_panel_2.createParallelGroup(Alignment.LEADING, false)
								.addComponent(lblFromUnit, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addComponent(unit1, 0, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
								.addGroup(gl_panel_2.createSequentialGroup()
									.addComponent(t1, GroupLayout.PREFERRED_SIZE, 148, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.UNRELATED)
									.addComponent(U1, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
								...
								.addGroup(gl_panel_2.createSequentialGroup()
									.addComponent(t2, GroupLayout.PREFERRED_SIZE, 148, GroupLayout.PREFERRED_SIZE)
									.addPreferredGap(ComponentPlacement.UNRELATED)
